    ...
    $("#Select").click(function(){
        ...
        $.getJSON("<?php echo U('Get/GetTerm');?>",{},function(data){
            ...
            if(flag+1)
            {
                ...
                var search="<form action=\"<?php echo U('Search/SelectSearch');?>\"><table><tr><td>课程号<input type=\"text\" name=\"course_id\" placeholder='08300001'></td>" +
                        "<td>课程名<input type=\"text\" name=\"course_name\" placeholder='数据结构'></td>" +
                        "<td>教师号<input type=\"text\" name=\"teacher_id\" placeholder='0001'></td>" +
                        "<td>教师名<input type=\"text\" name=\"name\" placeholder='赵正德'></td></tr>" +
                        "<tr><td>上课时间<input type=\"text\" name=\"time\" placeholder='三9'></td>" +
                        "<td>上课地点<input type=\"text\" name=\"address\" placeholder='A101'></td>" +
                        "<td>学分<input type=\"text\" name=\"point\" placeholder='4'></td></tr>" +
                        "<tr><td><input type=\"submit\" id=\"submit\" name=\"submit\" value=\"搜索\"></td></tr> " +
                        "</table></form>"
