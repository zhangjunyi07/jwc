...
//        console.log("lalala");
    ...
    $(document).ready(function() {
        $("#SetElectiveTime").click(function(){
            console.log("settime");
            var nnn = new Date();
            var set="<form><table><tr><th>请选择学期<select id=\"term\" name=\"term\">" ;
           ...
           set+= "</select></th></tr>" +
                 "<tr><th>第<select id=\"turns\" name=\"turns\"><option value=\"1\">1</option><option value=\"2\">2</option></select>轮选课</th></tr>" +
           "</table></form>"
            $("#addcontent").html(set);
            $("#add").show(1000);
        });
